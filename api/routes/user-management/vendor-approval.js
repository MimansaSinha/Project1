        ...
        try {
            // if(result){
                const now  =  new Date();
                        ...
                        sqlQuery = " UPDATE tbl_vendor SET status=$1, action_on=$2, action_by=$3, comment=$4 WHERE vendor_id='"+req.params.vendor_id+"'"
