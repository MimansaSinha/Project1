...
router.get('/', async(req, res) => {
    ...
    var result;
    try {
        sqlQuery = "SELECT order_id,TO_CHAR(DATE(order_date),'dd-mm-yyyy') as order_date,'3-04-2023' as cancellation_date,'Vendor' as cancel_by,amount,enabled FROM tbl_order_header";
